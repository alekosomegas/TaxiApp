...
import com.ak.taxiapp.model.CarDAO;
...
public class NewCarDialogController extends Controller{
    ...
    public void insertCar() throws SQLException {
        CarDAO.insertCar(tfRegistration.getText(),tfMake.getText(),tfModel.getText(),Integer.parseInt(tfMileage.getText()));
    }
    ...
    @FXML public void updateCar() throws SQLException {
        ...
        CarDAO.updateCar(selectedCarValues);
    }
