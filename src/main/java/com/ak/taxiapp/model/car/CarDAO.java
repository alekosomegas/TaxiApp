package com.ak.taxiapp.model.car;
...
public class CarDAO {
    ...
    public static void delete(Integer carID) throws SQLException {
    ...
    public static void insert(String reg, String make, String model, Integer mileage) throws SQLException {
