...
public class DriverDAO {
    ...
    public static void insertDriver(String name, Integer carId, String color) throws SQLException {
    ...
    public static void updateDriver(HashMap<String, String> values) throws SQLException {
